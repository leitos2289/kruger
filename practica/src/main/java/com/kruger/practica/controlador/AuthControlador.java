...
import com.kruger.practica.dto.LoginDTO;
...
import com.kruger.practica.seguridad.JWTAuthResonseDTO;
import com.kruger.practica.seguridad.JwtTokenProvider;
...
public class AuthControlador {
	...
	public ResponseEntity<?> registrarUsuario(@RequestBody RegistroDTO registroDTO){
		...
		Rol roles = rolRepositorio.findByNombre("EMPLEADO").get();
